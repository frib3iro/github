...
lista=(arch archlinux archlinuxMBR bspwm cinnamon curso-java-basico debian github gnome grub i3wm Java JavaGame_DoomFire MegaSena plymouth Scripts Snake ssh vbz zsh)
